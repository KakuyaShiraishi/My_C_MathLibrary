...
void SIMDx86Matrix_Multiply(SIMDx86Matrix* pLeft, const SIMDx86Matrix* pRight)
{
	...
	SIMDx86Matrix_MultiplyOf(pLeft, &temp, pRight);
...
void SIMDx86Matrix_Vector4Multiply(float* pOut4D, const SIMDx86Matrix* pMat)
{
	#if defined(USE_SSE)
...
SIMDx86Matrix* SIMDx86Matrix_Inverse(SIMDx86Matrix* pMat)
{
	...
	det =
		-pMat->m[12] * (pMat->m[1] * det01 - pMat->m[2] * det02 + pMat->m[3] * det03) +
		pMat->m[13] * (pMat->m[0] * det01 - pMat->m[2] * det04 + pMat->m[3] * det05) -
		pMat->m[14] * (pMat->m[0] * det02 - pMat->m[1] * det04 + pMat->m[3] * det06) +
		pMat->m[15] * (pMat->m[0] * det03 - pMat->m[1] * det05 + pMat->m[2] * det06);
