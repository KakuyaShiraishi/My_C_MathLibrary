...
void SIMDx86Matrix_AlignedSumOf(SIMDx86Matrix* Out, const SIMDx86Matrix* In1, const SIMDx86Matrix* In2)
{
...
void SIMDx86Matrix_AlignedDiff(SIMDx86Matrix* Out, const SIMDx86Matrix* In)
{
	#if defined(USE_SSE)
...
void SIMDx86Matrix_AlignedDiffOf(SIMDx86Matrix* Out, const SIMDx86Matrix* In1, const SIMDx86Matrix* In2)
{
	#if defined(USE_SSE)
	asm(
	"movaps   (%0), %%xmm0\n"
...
void SIMDx86Matrix_AlignedScale(SIMDx86Matrix* mtx, float scalar)
{
	#if defined(USE_SSE)
